...
export default function MiniDrawer(props) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} sx={{ display: { xs: open ? "block" : "none", sm: open ? "block" : "block"}}} > 
        <DrawerHeader sx={{ bgcolor: "#124A72"}}>
            ...
            <ListItem key={item.value} disablePadding sx={{ display: "block" }}>
              <Link to={item.link} style={{ textDecoration: "none", color: "#495464" }}>
                ...
                >
                  ...
                  <ListItemText primary={item.value} sx={{ opacity: open ? 1 : 0, color: "#f4f4f4" }} />
                </ListItemButton>
              </Link>
            </ListItem>
          ))}
